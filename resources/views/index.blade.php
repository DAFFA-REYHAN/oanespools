...
@section('content')
    ...
    <section class="relative px-6 pb-32">
      <div
        ...
        <!-- Text Content -->
        <div
          class="absolute inset-0 flex flex-col justify-center px-8 sm:px-12 lg:px-20 text-white">
          ...
          <a
            href="#"
            class="font-semibold mt-6 w-max px-5 py-3 border border-white rounded-full text-sm hover:bg-white hover:text-black transition"
            >Hubungi Kami</a
          >
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="relative rounded-2xl overflow-hidden shadow-lg group">
            ...
            <div class="absolute bottom-4 left-4 text-white">
              <h3 class="text-xl font-semibold">Perawatan</h3>
              <p class="text-lg">Kolam Renang</p>
            </div>
          </div>
          ...
          <div class="relative rounded-2xl overflow-hidden shadow-lg group">
            <img
              ...
              alt="Pembangunan Kolam Renang"
              class="w-full h-80 object-cover group-hover:scale-105 transition" />
            <div
              class="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent"></div>
            <div class="absolute bottom-4 left-4 text-white">
              <h3 class="text-xl font-semibold">Pembangunan</h3>
              <p class="text-lg">Kolam Renang</p>
            </div>
          </div>
          ...
          <div class="relative rounded-2xl overflow-hidden shadow-lg group">
            <img
              ...
              alt="Renovasi Kolam Renang"
              class="w-full h-80 object-cover group-hover:scale-105 transition" />
            <div
              class="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent"></div>
            <div class="absolute bottom-4 left-4 text-white">
              <h3 class="text-xl font-semibold">Renovasi</h3>
              <p class="text-lg">Kolam Renang</p>
            </div>
          </div>
        </div>
    ...
    <footer class="bg-black text-white px-6 py-16">
      ...
      <!-- Bawah: Copyright -->
      <div
        class="mt-12 border-t border-gray-700 pt-6 text-center text-sm text-gray-400">
